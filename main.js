...
var startDate = new Date(2016,6,8,10,30); // July 8th, 10:30
var endDate = new Date(2016,6,8,14,00); // July 8th, 14:00
...
/*
 * Answer should be :
 * the company is not available on this range of date
 */

// var fromDate = new Date(2020,6,4,10,00);
// var toDate = new Date(2020,6,10,10,00);
// Event.prototype.availabilities(fromDate, toDate);
/*
 * Answer should be :
 * the company is not available on this range of date
